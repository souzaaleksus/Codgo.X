...
function TFormMain.CriticalDataEnterHTTP : Boolean;
  begin
    ...
    then
    begin
      ShowMessage( 'A natureza é obrigatória.' );
    ...
    then
    begin
      ShowMessage( 'O documento é obrigatório.' );
    ...
    then
    begin
      ShowMessage( 'O primeiro nome é obrigatório.' );
    ...
    then
    begin
      ShowMessage( 'O segundo nome é obrigatório.' );
